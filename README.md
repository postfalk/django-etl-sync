...
1. Use the `Mapper` class to specify all ETL operations. If you need
...
2. Use the `Generator`. This class maps dictionary keys into a Django model and returns an instance. In this case
